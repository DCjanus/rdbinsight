...
use super::{
    fixtures::{
        ...
        record_list::{ListRecordFixture, ListZipListRecordFixture},
        record_set::{SetIntSetRecordFixture, SetRecordFixture},
...
fn default_fixtures() -> Vec<DynFixture> {
    vec![
        ...
        Box::new(ListZipListRecordFixture::new()),
        Box::new(SetRecordFixture::new()),
        Box::new(SetIntSetRecordFixture::new()),
